        ...
        <div class="row">
            <div class="col-lg-2 mt-4">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link active" href="/home" role="tab">Home</a>
                    <a class="nav-link" href="#" role="tab">Profile</a>
            ...
            <div class="col-lg-10">
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium alias, architecto assumenda atque beatae error, esse eveniet expedita ipsa labore, libero quia quidem repellendus sed soluta ullam vel! At distinctio illo, iste nam repellat soluta. Accusamus aliquam consequuntur modi, odit omnis recusandae veritatis voluptas voluptatibus? A accusantium molestias quis unde?</p>
                    </div>
                </div>
            </div>
        </div>
